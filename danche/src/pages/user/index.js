...
export default class User extends React.Component{
   ...
   hanleOperate=(type)=>{
       ...
       switch(type){
           case 'create':return this.setState({type,
            isVisible:true,
            title:'创建员工'})
            break;
            case 'edit':if(!item){
   ...
   handleOk = ()=>{
    ...
    render(){
        ...
        return (
            <div>
                <Card>
                    <BeasForm formList={this.formList} filterSubmit={this.handleFilter}/>
                    
                </Card>
                <Card style={{marginTop:10}} className="operate-warp">
                    <Button type="primary" icon="plus" onClick={()=>this.hanleOperate('create')}>创建员工</Button>
                    <Button icon="edit" onClick={()=>this.hanleOperate('edit')}>编辑员工</Button>
                    <Button onClick={()=>this.hanleOperate('detail')}>员工详情</Button>
                    <Button type="danger" icon="delete" onClick={()=>this.hanleOperate  ('delete')}>删除员工</Button>
                </Card>
